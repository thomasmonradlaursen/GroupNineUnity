...
public class VerticesGenerator : MonoBehaviour
{
    ...
    public int boardHeigth = 4;
    public int numberOfHorizontalVertices = 4;
    public int numberOfVerticalVertices = 4;
    ...
    {
        float xInterval = (float)boardLength / ((float)numberOfHorizontalVertices - 1);
        float yInterval = (float)boardHeigth / ((float)numberOfVerticalVertices - 1);
        //Debug.Log(xInterval);
        //Debug.Log(yInterval);
