...
public class FitCameraToPuzzle : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // // Get points to determine camera placement
        // var points = new Vector3[4];
        // idx = 0;
        // foreach (var point in shape)
        // {
        //     points[idx].x = point.coord.x;
        //     points[idx].y = point.coord.y;
        //     idx++;
        // }

        // sceneHeight = (points[2].y - points[0].y) * 2;
        // Debug.Log(sceneHeight);
        // sceneWidth = (points[2].x - points[0].x) * 2;
